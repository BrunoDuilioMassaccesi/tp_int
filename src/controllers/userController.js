...
const login = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: 'Error en login', details: error.message });
  }
};
...
const register = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: 'Error en registro', details: error.message });
  }
};
